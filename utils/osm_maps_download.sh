...
wget -c "http://download.osmand.net/download.php?standard=yes&file=Chile_southamerica_2.obf.zip" -O Chile_southamerica_2.obf.zip
...
wget -c http://direct.mapswithme.com/direct/latest/Peru.mwm.routing
wget -c http://direct.mapswithme.com/direct/latest/Chile.mwm.routing
wget -c http://direct.mapswithme.com/direct/latest/Ecuador.mwm.routing
wget -c http://direct.mapswithme.com/direct/latest/Bolivia.mwm.routing
